...
class ISOCountry(
    ...
    AE = 784, "AE", "ARE", True, "United Arab Emirates (the)", "the United Arab Emirates"
    ...
    BO = 68, "BO", "BOL", True, "Bolivia (Plurinational State of)", "the Plurinational State of Bolivia"
    BQ = 535, "BQ", "BES", False, "Bonaire, Sint Eustatius and Saba", "Bonaire, Sint Eustatius and Saba"
    ...
    CC = 166, "CC", "CCK", False, "Cocos (Keeling) Islands (the)", "Cocos (Keeling) Islands (the)"
    CD = 180, "CD", "COD", True, "Congo (the Democratic Republic of the)", "the Democratic Republic of the Congo"
    CF = 140, "CF", "CAF", True, "Central African Republic (the)", "the Central African Republic"
    ...
    ET = 231, "ET", "ETH", True, "Ethiopia", "the Federal Democratic Republic of Ethiopia"
    FI = 246, "FI", "FIN", True, "Finland", "the Republic of Finland"
    FJ = 242, "FJ", "FJI", True, "Fiji", "the Republic of Fiji"
    FK = 238, "FK", "FLK", False, "Falkland Islands (the) [Malvinas]", "Falkland Islands (the) [Malvinas]"
    FM = 583, "FM", "FSM", True, "Micronesia (Federated States of)", "the Federated States of Micronesia"
    ...
    GB = 826, "GB", "GBR", True, "United Kingdom of Great Britain and Northern Ireland (the)", "the United Kingdom of Great Britain and Northern Ireland"
    ...
    GQ = 226, "GQ", "GNQ", True, "Equatorial Guinea", "the Republic of Equatorial Guinea"
    GR = 300, "GR", "GRC", True, "Greece", "the Hellenic Republic"
    GS = 239, "GS", "SGS", False, "South Georgia and the South Sandwich Islands", "South Georgia and the South Sandwich Islands"
    ...
    HK = 344, "HK", "HKG", False, "Hong Kong", "the Hong Kong Special Administrative Region of China"
    HM = 334, "HM", "HMD", False, "Heard Island and McDonald Islands", "Heard Island and McDonald Islands"
    ...
    IO = 86, "IO", "IOT", False, "British Indian Ocean Territory (the)", "British Indian Ocean Territory (the)"
    IQ = 368, "IQ", "IRQ", True, "Iraq", "the Republic of Iraq"
    IR = 364, "IR", "IRN", True, "Iran (Islamic Republic of)", "the Islamic Republic of Iran"
    ...
    KP = 408, "KP", "PRK", True, "Korea (the Democratic People's Republic of)", "the Democratic People's Republic of Korea"
    ...
    LA = 418, "LA", "LAO", True, "Lao People's Democratic Republic (the)", "the Lao People's Democratic Republic"
    ...
    LK = 144, "LK", "LKA", True, "Sri Lanka", "the Democratic Socialist Republic of Sri Lanka"
    ...
    MF = 663, "MF", "MAF", False, "Saint Martin (French part)", "Saint Martin (French part)"
    MG = 450, "MG", "MDG", True, "Madagascar", "the Republic of Madagascar"
    MH = 584, "MH", "MHL", True, "Marshall Islands (the)", "the Republic of the Marshall Islands"
    ...
    MO = 446, "MO", "MAC", False, "Macao", "Macao Special Administrative Region of China"
    MP = 580, "MP", "MNP", False, "Northern Mariana Islands (the)", "the Commonwealth of the Northern Mariana Islands"
    ...
    PG = 598, "PG", "PNG", True, "Papua New Guinea", "the Independent State of Papua New Guinea"
    ...
    PM = 666, "PM", "SPM", False, "Saint Pierre and Miquelon", "Saint Pierre and Miquelon"
    ...
    SH = 654, "SH", "SHN", False, "Saint Helena, Ascension and Tristan da Cunha", "Saint Helena, Ascension and Tristan da Cunha"
    ...
    ST = 678, "ST", "STP", True, "Sao Tome and Principe", "the Democratic Republic of Sao Tome and Principe"
    SV = 222, "SV", "SLV", True, "El Salvador", "the Republic of El Salvador"
    SX = 534, "SX", "SXM", False, "Sint Maarten (Dutch part)", "Sint Maarten (Dutch part)"
    SY = 760, "SY", "SYR", True, "Syrian Arab Republic (the)", "the Syrian Arab Republic"
    SZ = 748, "SZ", "SWZ", True, "Eswatini", "the Kingdom of Eswatini"
    TC = 796, "TC", "TCA", False, "Turks and Caicos Islands (the)", "Turks and Caicos Islands (the)"
    TD = 148, "TD", "TCD", True, "Chad", "the Republic of Chad"
    TF = 260, "TF", "ATF", False, "French Southern Territories (the)", "French Southern Territories (the)"
    ...
    TT = 780, "TT", "TTO", True, "Trinidad and Tobago", "the Republic of Trinidad and Tobago"
    TV = 798, "TV", "TUV", True, "Tuvalu", "Tuvalu"
    TW = 158, "TW", "TWN", False, "Taiwan (Province of China)", "Taiwan (Province of China)"
    TZ = 834, "TZ", "TZA", True, "Tanzania, the United Republic of", "the United Republic of Tanzania"
    UA = 804, "UA", "UKR", True, "Ukraine", "Ukraine"
    UG = 800, "UG", "UGA", True, "Uganda", "the Republic of Uganda"
    UM = 581, "UM", "UMI", False, "United States Minor Outlying Islands (the)", "United States Minor Outlying Islands (the)"
    US = 840, "US", "USA", True, "United States of America (the)", "the United States of America"
    ...
    VC = 670, "VC", "VCT", True, "Saint Vincent and the Grenadines", "Saint Vincent and the Grenadines"
    VE = 862, "VE", "VEN", True, "Venezuela (Bolivarian Republic of)", "the Bolivarian Republic of Venezuela"
    VG = 92, "VG", "VGB", False, "Virgin Islands (British)", "British Virgin Islands (the)"
    VI = 850, "VI", "VIR", False, "Virgin Islands (U.S.)", "the Virgin Islands of the United States"
